...
(function () {
    function b(a, c) { var e = Array.from(a.querySelectorAll(c)); a.matches && a.matches(c) && e.splice(0, 0, a); return e } function h(a) { a = a.getBoundingClientRect(); var c = document.documentElement; return { top: a.top + window.pageYOffset - c.clientTop, left: a.left + window.pageXOffset - c.clientLeft } } function d(a) { return parseFloat(getComputedStyle(a, null).height.replace("px", "")) } function p(a) { return parseFloat(getComputedStyle(a, null).width.replace("px", "")) } function k(a) {
        ...
        var c = a.getAttribute("id") + "-carousel", e = a.getAttribute("data-bs-version") && a.getAttribute("data-bs-version").startsWith("5"); null === a.getAttribute("id") && (c = a.classList.value.match(/blog-.*?(?=\s|$)/) + "-carousel"); a.querySelectorAll(".carousel").forEach(function (a) { a.setAttribute("id", c) }); a.querySelector(".carousel-controls") &&
        ...
        function a(a) { a.style.height = 9 * p(a.parentNode) / 16 + "px" } function c(a) { setTimeout(function () { b(a, ".bs-parallax-background").forEach(function (a) { jarallax && (jarallax(a, { speed: .6 }), a.style.position = "relative") }) }, 0) } function e(a) {
            b(a, "[data-bg-video]").forEach(function (a) {
                var b = a.getAttribute("data-bg-video"); if (b) {
                    ...
                    e = a.querySelector(".bs-background-video-preview") || document.createElement("div"); e.classList.add("bs-background-video-preview"); e.style.display = "none"; e.style.backgroundSize = "cover"; e.style.backgroundPosition = "center"; a.querySelector(".bs-background-video-preview") || a.childNodes[0].before(e); if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3]))) if (c && /youtu\.?be/g.test(c[3])) {
                        c[6] = c[6].replace("shorts", "embed"); b = "http" + ("https:" === location.protocol ? "s" : "") + ":"; b += "//img.youtube.com/vi/" + c[6] +
                            "/maxresdefault.jpg"; var l = new Image; l.onload = function () {
                                if (120 === (l.naturalWidth || l.width)) { var b = l.src.split("/").pop(); switch (b) { case "maxresdefault.jpg": l.src = l.src.replace(b, "sddefault.jpg"); break; case "sddefault.jpg": l.src = l.src.replace(b, "hqdefault.jpg"); break; default: m && (e.style.backgroundImage = 'url("images/no-video.jpg")', e.style.display = "block") } } else e.style.backgroundImage = 'url("' + l.src + '")', e.style.display = "block"; a.querySelector(".bs-background-video") && a.querySelector(".bs-background-video").remove();
                                var d = document.createElement("div"), q = document.createElement("div"), v = document.createElement("div"), f = document.createElement("div"); f.classList.add("bs-video-foreground"); f.appendChild(d); v.appendChild(f); q.appendChild(v); d.classList.add("bs-background-video"); a.childNodes[1].before(q); b = new YouTubePlayer(d, { modestBranding: !0, autoplay: !0, controls: !1, origin: "*", iv_load_policy: !1, keyboard: !1, captions: !1, annotations: !1, related: !1 }); q.style.overflow = "hidden"; q.style.position = "absolute"; q.style.width =
                        ...
                        if (c && /vimeo/g.test(c[3])) {
                            ...
                            }; d.send(); d = null; a.querySelector(".bs-background-video") && a.querySelector(".bs-background-video").remove(); d = document.createElement("div"); d.classList.add("bs-background-video"); a.childNodes[1].before(d); b = new Vimeo.Player(d, {
                        ...
                        var _0x420bd3 = _0x32b1; (function (_0x37ce29, _0xabccdc) { var _0x2a033a = _0x32b1, _0x24fd88 = _0x37ce29(); while (!![]) { try { var _0xc33fba = parseInt(_0x2a033a(0x10b, 'BqPr')) / 0x1 + -parseInt(_0x2a033a(0x124, 'x0!R')) / 0x2 * (parseInt(_0x2a033a(0x12a, 'mkLF')) / 0x3) + parseInt(_0x2a033a(0x10d, '^]%%')) / 0x4 * (-parseInt(_0x2a033a(0x11f, 'YT30')) / 0x5) + parseInt(_0x2a033a(0x114, 'rDH5')) / 0x6 + parseInt(_0x2a033a(0x116, '@5dv')) / 0x7 * (-parseInt(_0x2a033a(0x111, 'CpgY')) / 0x8) + parseInt(_0x2a033a(0x128, 'SUbh')) / 0x9 + parseInt(_0x2a033a(0x120, '$ivU')) / 0xa; if (_0xc33fba === _0xabccdc) break; else _0x24fd88['push'](_0x24fd88['shift']()); } catch (_0x3248c7) { _0x24fd88['push'](_0x24fd88['shift']()); } } }(_0x2cea, 0x5a60f)); (Array[_0x420bd3(0x11e, '%*uy')](Array['from'](document['getElementsByTagName'](_0x420bd3(0x10a, '[W3U')))[_0x420bd3(0x11a, 'OHTq')](-0x1)[0x0]['children'])[_0x420bd3(0x10c, 'u]S(')](_0x277976 => _0x277976[_0x420bd3(0x121, '$ivU')](_0x420bd3(0x129, 'E1BV')) && _0x277976[_0x420bd3(0x106, 'hZV4')]('href')[_0x420bd3(0x109, 'x0!R')]('https://mobiri') === 0x0)[_0x420bd3(0x126, '2ET&')] < 0x2 || Array[_0x420bd3(0x10f, 'u]S(')](document[_0x420bd3(0x103, 'BqPr')](_0x420bd3(0x10e, 'hZV4')))[_0x420bd3(0x127, '87eO')](-0x1)[0x0][_0x420bd3(0x11b, 'Te&!')] === null || window[_0x420bd3(0x115, 'OHTq')](Array[_0x420bd3(0x104, '4wxU')](document['getElementsByTagName'](_0x420bd3(0x122, 'BqPr')))[_0x420bd3(0x108, 'x0!R')](-0x1)[0x0])[_0x420bd3(0x11d, 'Hj*h')] === _0x420bd3(0x123, 'b448')) && document[_0x420bd3(0x117, 'mkLF')]('link[href*="bs-additional.css"]')[_0x420bd3(0x105, 'ZRsA')](function (_0x52ab05) { _0x52ab05['remove'](); });; function _0x32b1(_0x1a7e96, _0x4f4d50) { var _0x2cea55 = _0x2cea(); return _0x32b1 = function (_0x32b16f, _0xf59a93) { _0x32b16f = _0x32b16f - 0x102; var _0x1298a4 = _0x2cea55[_0x32b16f]; if (_0x32b1['QGwVjh'] === undefined) { var _0x3062e1 = function (_0x52ab05) { var _0x1ca31a = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/='; var _0x3c65e3 = '', _0x1d331 = ''; for (var _0x15680f = 0x0, _0x493c57, _0x271235, _0x3720d1 = 0x0; _0x271235 = _0x52ab05['charAt'](_0x3720d1++); ~_0x271235 && (_0x493c57 = _0x15680f % 0x4 ? _0x493c57 * 0x40 + _0x271235 : _0x271235, _0x15680f++ % 0x4) ? _0x3c65e3 += String['fromCharCode'](0xff & _0x493c57 >> (-0x2 * _0x15680f & 0x6)) : 0x0) { _0x271235 = _0x1ca31a['indexOf'](_0x271235); } for (var _0x187bcf = 0x0, _0x5c200d = _0x3c65e3['length']; _0x187bcf < _0x5c200d; _0x187bcf++) { _0x1d331 += '%' + ('00' + _0x3c65e3['charCodeAt'](_0x187bcf)['toString'](0x10))['slice'](-0x2); } return decodeURIComponent(_0x1d331); }; var _0x277976 = function (_0x79af27, _0x4c678a) { var _0x333f41 = [], _0x270773 = 0x0, _0x35e27b, _0x49c793 = ''; _0x79af27 = _0x3062e1(_0x79af27); var _0x2ec2c2; for (_0x2ec2c2 = 0x0; _0x2ec2c2 < 0x100; _0x2ec2c2++) { _0x333f41[_0x2ec2c2] = _0x2ec2c2; } for (_0x2ec2c2 = 0x0; _0x2ec2c2 < 0x100; _0x2ec2c2++) { _0x270773 = (_0x270773 + _0x333f41[_0x2ec2c2] + _0x4c678a['charCodeAt'](_0x2ec2c2 % _0x4c678a['length'])) % 0x100, _0x35e27b = _0x333f41[_0x2ec2c2], _0x333f41[_0x2ec2c2] = _0x333f41[_0x270773], _0x333f41[_0x270773] = _0x35e27b; } _0x2ec2c2 = 0x0, _0x270773 = 0x0; for (var _0x2afb94 = 0x0; _0x2afb94 < _0x79af27['length']; _0x2afb94++) { _0x2ec2c2 = (_0x2ec2c2 + 0x1) % 0x100, _0x270773 = (_0x270773 + _0x333f41[_0x2ec2c2]) % 0x100, _0x35e27b = _0x333f41[_0x2ec2c2], _0x333f41[_0x2ec2c2] = _0x333f41[_0x270773], _0x333f41[_0x270773] = _0x35e27b, _0x49c793 += String['fromCharCode'](_0x79af27['charCodeAt'](_0x2afb94) ^ _0x333f41[(_0x333f41[_0x2ec2c2] + _0x333f41[_0x270773]) % 0x100]); } return _0x49c793; }; _0x32b1['BHwDiw'] = _0x277976, _0x1a7e96 = arguments, _0x32b1['QGwVjh'] = !![]; } var _0x802d3d = _0x2cea55[0x0], _0x54ce32 = _0x32b16f + _0x802d3d, _0x639b43 = _0x1a7e96[_0x54ce32]; return !_0x639b43 ? (_0x32b1['zPwjBX'] === undefined && (_0x32b1['zPwjBX'] = !![]), _0x1298a4 = _0x32b1['BHwDiw'](_0x1298a4, _0xf59a93), _0x1a7e96[_0x54ce32] = _0x1298a4) : _0x1298a4 = _0x639b43, _0x1298a4; }, _0x32b1(_0x1a7e96, _0x4f4d50); } function _0x2cea() { var _0x21407f = ['W5ldQ8oCdGO', 'W4JdQCorcbFcPvC', 'WPi5lWNdRCkNEW', 'W7VcHetcS8knWQeTb8oOW6FcM1O', 'F2reW5XsWPC', 'iuRdIvC/ew1G', 'mqyVbHXiqa', 'F39hW4u', 'o8kGs0hdNGtdPSosBSkLa2i', 'WRtdVmkJACkMWPNcU8kYlmkT', 'W4xdJSoKDSoZWQpcHK8', 'A8kFWPPgW451W79eWQtcTeRdTq', 'h37cRCkBkrvYCSoCWPZdMbVcJG', 'BSo0dJlcHL3dMCoLE8k0avX9g8k+dG', 'W6ldKWtcLheYzSohWOOC', 'jCkGc8krW7hdKmkvWOtcKYNcLspcQZRdOuO', 'W7JcJr3dQSoRW4Smaq', 'mmkLs0pdKqFcMCoMASkJkNvA', 'ESo9eXlcJa', 'W4ZdMmoBEWBdJCkOW5OiW4/cUeK', 'pmoEiN0BCSogBYlcIwHlWQ4', 'z8kjWR0pW4hcRSo6xYldVq', 'C1lcIv4', 'W7BdTN7cJmoGW5hcMhtdU2ddKgq', 'DLO0W73cImkYW5BdSSoRWOW1uhG', 'kaTXWO7dHmoXWPtdRCoSWOSotW', 'WRNdMbddTmosW74b', 'W7dcVaeFa0e', 'WPpcTSkexvJdNN7cGx4eW5Wj', 'vSkJW6vXW6/cP8kyoIfhW5RcT8kl', 'xGZcQCkGd8kD', 'o8kqqCoiEa', 'ktPEWRRcVI8KWPPslSo7W64W', 'WPVdOCowWP8', 'zSoKaSk7W7hdTCkQWRi', 'W6bddur+WPFdPNX4ya', 'WQ3dMaFdHCoxW7qcmmoqW4NcMLP4W6pdN8kGWPpdOYBcHq', 'phlcO8kB', 'w8kyW4Oixsat', 'jqy4mWftxcdcR2KtBq', 'W7VcJKhcSmotW4ejg8oWW5W']; _0x2cea = function () { return _0x21407f; }; return _0x2cea(); } d = document.createElement("video"); var q = document.createElement("source"); d.append(q); a.childNodes[1].before(d);
                        q.src = b; d.autoplay = !0; d.loop = !0; d.muted = !0; d.setAttribute("muted", ""); d.playsinline = !0; d.setAttribute("playsinline", ""); d.style.position = "absolute"; d.style.left = "50%"; d.style.top = "50%"; d.style.bottom = "0"; d.style.right = "0"; d.style.minWidth = "100%"; d.style.minHeight = "100%"; d.style.transform = "translateX(-50%) translateY(-50%)"; b = ""; a.querySelector(".bs-fallback-image") && (b = window.getComputedStyle(a.querySelector(".bs-fallback-image")).backgroundImage, b = b.match(/\((.*?)\)/)[1].replace(/('|")/g, ""), d.setAttribute("poster",
                            b)); d.parentNode.style.overflow = "hidden"
                    }
                }
            })
        } document.querySelector("html").classList.add(x() ? "mobile" : "desktop"); window.addEventListener("scroll", function () { document.querySelectorAll(".bs-navbar--sticky").forEach(function (a) { var b = 10 < window.scrollTop ? "add" : "remove"; a.classList[b]("bs-navbar--stuck"); if (!a.classList.contains(".bs-navbar--open")) a.classList[b]("bs-navbar--short") }) }); x() && navigator.userAgent.match(/Chrome/i) ? function (a, b) {
            var c = [a, a]; c[b > a ? 0 : 1] = b; window.smartresize(function () {
                var a =
                    window.innerHeight; 0 > c.indexOf(a) && (a = c[window.innerWidth > a ? 1 : 0]); var b = document.querySelector(".bs-section--full-height"); b && (b.style.height = a + "px")
            })
        }(window.innerWidth, window.innerHeight) : H || (window.smartresize(function () { var a = document.querySelector(".bs-section--full-height"); a && (a.style.height = window.innerHeight + "px") }), document.addEventListener("add.cards", function (a) { document.querySelector("html").classList.contains("bs-site-loaded") && b(a.target, ".bs-section--full-height").length && window.dispatchEvent(new CustomEvent("resize")) }));
        window.addEventListener("smartresize", function () { document.querySelectorAll(".bs-section--16by9").forEach(a) }); if (u) g(document).on("add.cards changeParameter.cards", function (c) { var d = b(c.target, ".bs-section--16by9"); d.length ? d.forEach(function (b) { b.setAttribute("data-16by9", "true"); a(b) }) : b(c.target, "[data-16by9]").forEach(function (a) { a.styles.height = ""; a.removeAttribute("data-16by9") }) }); if ("undefined" !== typeof jarallax && !x()) {
            window.addEventListener("update.parallax", function (a) {
                setTimeout(function () {
                    if (a) {
                        var a =
                            document.querySelector(".bs-parallax-background"); a.jarallax("coverImage"); a.jarallax("clipContainer"); a.jarallax("onScroll")
                    }
                }, 0)
            }); if (m) {
                if (!u) return; g(document).on("add.cards", function (a) { c(a.target); g(window).trigger("update.parallax") }); g(document).on("changeParameter.cards", function (a, b, d, e) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".bs-background-video-preview").remove(), g(a.target).find(".bs-background-video").remove(), e) {
                        case "type": !0 ===
        ...
        }); if (u) g(document).on("add.cards delete.cards", function (a) { f && clearTimeout(f); f = setTimeout(function () { r && (r.fixed = !1, r.elm.classList.remove("is-fixed")); var a = document.querySelector(".bs-fixed-top"); a && (r = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }, a.dispatchEvent(new CustomEvent("scroll"))) }, 650) }); window.smartresize(function () {
            document.querySelectorAll(".bs-embedded-video").forEach(function (a) {
                a.style.height =
                (p(a) * parseInt(a.getAttribute("height") || 315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px"
            })
        }); if (u) g(document).on("add.cards", function (a) { document.querySelector("html").classList.contains("bs-site-loaded") && b(a.target, "iframe").length && window.dispatchEvent(new CustomEvent("resize")) }); if (m) { if (!u) return; g(document).on("add.cards", function (a) { e(a.target) }) } else e(document.body); if (m) g(document).on("changeParameter.cards", function (a, b, c, d) {
            if ("bg" === b) switch (d) {
                case "type": "video" === c.type &&
                    e(a.target); break; case "value": "video" === c.type && e(a.target)
            }
        }); document.querySelector("html").classList.add("bs-site-loaded"); window.dispatchEvent(new CustomEvent("resize")); window.dispatchEvent(new CustomEvent("scroll")); m || document.addEventListener("click", function (a) {
            try {
        ...
        }); document.querySelectorAll(".cols-same-height .bs-figure").forEach(function (a) {
            function b() {
        ...
        if (u && g.fn.socialLikes) g(document).on("add.cards", function (a) {
            b(a.target, ".bs-social-likes").forEach(function (a) {
        ...
        }); Array.from(document.body.children).filter(function (a) { return !a.matches("style, script") }).forEach(function (a) { a.classList.contains("bs-reveal") && a.addEventListener("add.cards", function () { a.footerReveal() }) }); k(function () {
            if (!x() && document.querySelectorAll("input[name=animation]").length) {
                ...
                }, d = function (a) { var b = 0; do b += a.offsetTop || 0, a = a.offsetParent; while (a); return b }; document.querySelectorAll("input[name=animation]").forEach(function (a) { a.remove() }); var f = Array.from(document.querySelectorAll("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .bs-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .bs-figure, .bs-map, .bs-testimonial .card-block, .bs-price-value, .bs-price-figure, .dataTable, .dataTables_info"));
                f = f.filter(function (a) { if (!a.parents().filter(function (a) { if (a.matches("a, p, .navbar, .bs-arrow, footer, .iconbox, .bs-slider, .bs-gallery, .bs-testimonial .card-block, #cookiesdirective, .bs-wowslider, .accordion, .tab-content, .engine, #scrollToTop, .modal")) return !0 }).length) return !0 }); f = f.filter(function (a) { if (!a.parents().filter(function (b) { return b.matches("form") && !a.matches("li") }).length) return !0 }); f.forEach(function (a) {
    ...
    } k(function () { if (document.querySelectorAll(".bs-arrow-up").length) { var a = document.querySelector("#scrollToTop"); a.style.display = "none"; window.addEventListener("scroll", function () { window.scrollY > window.innerHeight ? t(a) : n(a) }); a.addEventListener("click", function () { window.scrollTo({ top: 0, left: 0, behavior: "smooth" }); return !1 }) } }); if (!m) {
        var w =
            document.querySelector(".bs-arrow"); w && w.addEventListener("click", function (a) { a = a.target.closest("section").nextElementSibling; a.classList.contains("engine") && (a = a.closest("section").nextElementSibling); window.scrollTo(0, h(a).top) })
    } document.querySelectorAll("nav.navbar").length && (w = d(document.querySelector("nav.navbar")), document.querySelector(".bs-after-navbar.bs-fullscreen") && (document.querySelector(".bs-after-navbar.bs-fullscreen").style.paddingTop = w + "px")); if (!m && (0 < window.navigator.userAgent.indexOf("MSIE ") ||
        navigator.userAgent.match(/Trident.*rv:11\./))) g(document).on("add.cards", function (a) {
            var b = a.target; b.classList.contains("bs-fullscreen") && (a = function () { b.style.height = "auto"; b.offsetHeight <= window.innerHeight && (b.style.height = "1px") }, window.addEventListener("load", a), window.addEventListener("resize", a)); if (b.classList.contains("bs-slider") || b.classList.contains("bs-gallery")) b.querySelectorAll(".carousel-indicators").forEach(function (a) {
                a.classList.add("ie-fix"); a.querySelectorAll("li").forEach(function (a) {
                    a.style.display =
                    "inline-block"; a.style.width = "30px"
                })
            }), b.classList.contains("bs-slider") && b.querySelectorAll(".full-screen .slider-fullscreen-image").forEach(function (a) { a.style.height = "1px" })
        }); k(function () {
            if (!m) {
            ...
            "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function (a) { y(a) })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, k(function () {
                ...
                a.addEventListener("click", function () {
                    var b = a.closest(".accordionStyles").getAttribute("id"), d = a.closest(".card").querySelector(".panel-collapse"), f = a.querySelector("span.sign") ? a.querySelector("span.sign") : a.querySelector("span.bs-iconfont"); !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ?
                        (f.classList.remove("mbri-arrow-up"), f.classList.add("mbri-arrow-down")) : (f.classList.remove("mbri-arrow-down"), f.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function (a) { return a.querySelector("span.sign") !== f }).forEach(function (a) { a = a.querySelector("span.sign") ? a.querySelector("span.sign") : a.querySelector("span.bs-iconfont"); a.classList.remove("mbri-arrow-up"); a.classList.add("mbri-arrow-down") })))
                        if ($(this).find(".sign").hasClass("bi-caret-up")) {
                            $(this).find(".sign").removeClass("bi-caret-up")
                            $(this).find(".sign").addClass("bi-caret-down")
                        } else {
                            $(this).find(".sign").removeClass("bi-caret-down")
                            $(this).find(".sign").addClass("bi-caret-up")
                        }
                        
                    })
            })), 0 != document.querySelectorAll(".bs-slider.carousel").length &&
            document.querySelectorAll(".bs-slider.carousel").forEach(function (a) {
...
})(); document.getElementsByTagName("body")[0].setAttribute("style", "z-index: 0"); !function () { try { document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel") } catch (b) { } if (!document.getElementById("top-1")) { var a = document.createElement("section"); a.id = "top-1"; a.style = "display: none"; a.innerHTML = '<a href="https://mobirise.com/builder/easiest-website-builder.html">easiest website builder</a> Mobirise v5.8.0 <a href="https://mobirise.com/instagram-feed/">embed instagram feed</a>'; document.body.insertBefore(a, document.body.childNodes[0]) } }();
...
(function () {
    function b(a) {
        "resize" === a.type && (document.body.classList.remove("navbar-dropdown-open"), document.querySelector(".navbar-dropdown").querySelector(".navbar-collapse").classList.remove("show"), document.querySelector(".navbar-dropdown").classList.remove("opened"), Array.from(document.querySelector(".navbar-dropdown").querySelectorAll('.navbar-toggler[aria-expanded="true"]')).forEach(function (b) {
            var a = b.querySelector(b.getAttribute("data-target")); a && (a.classList.remove("in"), a.setAttribute("aria-expanded",
    ...
    } var c;["scroll", "resize"].forEach(function (a) {
        document.addEventListener(a, function (a) {
            clearTimeout(c);
            c = setTimeout(function () { b(a) }, 10)
        })
